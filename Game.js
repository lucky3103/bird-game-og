  ...
  play(){
    ...
    if(allPlayers !== undefined){
      ...
      for(var plr in allPlayers){
        ...
        //position the birds a little away from each other in x direction
        x = x + 200;
        //use data form the database to display the birds in y direction
